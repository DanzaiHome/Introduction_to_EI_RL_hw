...
def main(grid_size,
    ...
    for episode in train_bar:
        ...
        if episode != 0 and episode % 100 == 0:
            torch.save(policy_net.state_dict(), d.save_dir_name + "/" + f"stable_agent{episode}.pth")
            print(f"Model saved as '{d.save_dir_name}/stable_agent{episode}.pth'")
    
    torch.save(policy_net.state_dict(), d.save_dir_name + "/stable_agent.pth")
    print(f"Training finished. Model saved as '{d.save_dir_name}/stable_agent.pth'.")
